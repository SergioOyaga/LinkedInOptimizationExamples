...
public class ReferencePanel extends JPanel {
    ...
    public ReferencePanel() {
        try {
            this.start = ImageIO.read(Objects.requireNonNull(ReferencePanel.class.getResource("/CurrentImages/Queens.png")));
            this.solution = ImageIO.read(Objects.requireNonNull(ReferencePanel.class.getResource("/CurrentSolutionImages/QueensSolve.png")));
