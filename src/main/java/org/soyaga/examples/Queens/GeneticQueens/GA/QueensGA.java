...
import org.soyaga.examples.Queens.GeneticQueens.GA.Stats.SolutionFoundStat;
import org.soyaga.examples.Queens.GeneticQueens.GA.Stats.UpdateFitnessStat;
 ...
 */
public class QueensGA extends StatsGeneticAlgorithm implements PropertyChangeListener, Runnable{
    /**
     ...
     */
    public QueensGA(String ID, QueensGAInitializer initializer, int populationSize) throws IOException {
        super(ID,
                populationSize,
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if(evt.getPropertyName().equals("solutionFound")){
            ...
            System.out.println(evt.getPropertyName()+ " not handled by the QueensGA");
        }
    }
}