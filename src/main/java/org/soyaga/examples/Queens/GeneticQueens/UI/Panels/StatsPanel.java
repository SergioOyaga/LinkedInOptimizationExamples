...
public class StatsPanel extends JPanel {
    ...
    public void addBestFitness(double bestIndividualFitness, double populationMeanFitness, double populationStandardDeviation){
        this.populationSeries.add(this.populationSeries.getItemCount(), populationMeanFitness,
                populationMeanFitness-populationStandardDeviation,
                populationMeanFitness+populationStandardDeviation);
        this.individualSeries.add(this.individualSeries.getItemCount(), bestIndividualFitness,
        ...
        if(this.annotation !=null) {
            this.annotation.setX(this.populationSeries.getItemCount()*0.8);
