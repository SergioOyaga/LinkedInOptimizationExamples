package org.soyaga.examples.Tango.MathModelTango.UI.Panels;
...
public class ReferencePanel extends JPanel {
    ...
    public ReferencePanel() {
        try {
            this.start = ImageIO.read(Objects.requireNonNull(ReferencePanel.class.getResource("/CurrentImages/Tango.png")));
            this.solution = ImageIO.read(Objects.requireNonNull(ReferencePanel.class.getResource("/CurrentSolutionImages/TangoSolve.png")));
