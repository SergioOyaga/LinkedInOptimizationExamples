package org.soyaga.examples.Zip.ACOZip.ACO;
...
import org.soyaga.examples.Zip.ACOZip.ACO.Stats.SolutionFoundStat;
import org.soyaga.examples.Zip.ACOZip.ACO.Stats.UpdatePheromoneStat;
import org.soyaga.examples.Zip.ACOZip.ACO.Evaluable.ZipFeasibilityFunction;
import org.soyaga.examples.Zip.ACOZip.Controller;
...
public class ZipACO extends StatsAntColonyAlgorithm implements PropertyChangeListener, Runnable{
    /**
    ...
    public ZipACO(String ID, World world, ACOInitializer acoInitializer ) throws IOException {
        super(ID,
                world,                                                              //World
                new Colony(),                                                       //Colony
                ...
                new SimpleUpdatePheromonePolicy(                                    //UpdatePheromonePolicy, first evaporate then add:
                        ...
                        new MinPercentageEvaporatePheromonePolicy(                  //EvaporatePheromonePolicy, percentage persistence:
                                0.96,                                                 //Double, persistence.
                                0.37                                                 // Double, min pheromone.
                        )
                ),
